<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"H:\phpstudy\PHPTutorial\WWW\tp5.0\public/../application/index\view\index\index.html";i:1525231803;}*/ ?>
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav">
                <ul>
                    <?php if($data): if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="images/nav1.png" /></span>
                            <span class="fl"><?php echo $vo['cate_name']; ?></span>
                        </div>
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                    <?php if($vo['son']): if(is_array($vo['son']) || $vo['son'] instanceof \think\Collection || $vo['son'] instanceof \think\Paginator): if( count($vo['son'])==0 ) : echo "" ;else: foreach($vo['son'] as $key=>$vv): ?>
                                    <a href="#"><?php echo $vv['cate_name']; ?></a>|
...
<div class="i_bg bg_color">
                ...
                <div id="block1">
                    <div id="botton-scroll1" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 1200px;">
                        <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                            <?php if($hot_data): if(is_array($hot_data) || $hot_data instanceof \think\Collection || $hot_data instanceof \think\Paginator): if( count($hot_data)==0 ) : echo "" ;else: foreach($hot_data as $key=>$vo): ?>
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    <div class="h_icon"><img width="50" height="50" src="images/hot.png">
                                    </div>
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="<?php echo $vo['goods_thumb']; ?>"></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="javascript:void(0)">
                                        <h2><?php echo $vo['goods_name']; ?></h2>
                                        <?php echo $vo['goods_brief']; ?>
                                        </a>
                                    </div>
                                    <div class="price">
                                        <font>￥<span><?php echo $vo['shop_price']; ?></span></font> &nbsp;
                                    </div>
                                </div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
    ...
    <!-- Begin 广告 Begin -->
    <div class="content mar_20">
        <img width="1200" height="110" src="images/mban_1.jpg">
    </div>    
    <!-- End 广告 End -->
