<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"H:\phpstudy\PHPTutorial\WWW\tp5.0\public/../application/admin\view\register\register.html";i:1524032779;}*/ ?>
...
<body>
	...
	<!-- 登录body -->
	<div class="logDiv">
        <form action="<?php echo url('Register/toregister'); ?>" method="post">
		...
		<div class="logGet">
			...
			<div class="lgD">
				<img class="img1" src="img/logName.png" /><input type="text"
					placeholder="输入用户名" name="u_name" />
			</div>
			<div class="lgD">
				<img class="img1" src="img/logPwd.png" /><input type="password"
					placeholder="输入用户密码" name="u_pwd"/>
			</div>
			<div class="lgD logD2">
