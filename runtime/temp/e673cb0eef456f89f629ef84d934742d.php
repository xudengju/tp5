<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"H:\phpstudy\PHPTutorial\WWW\tp5.0\public/../application/admin\view\index\head.html";i:1524033502;}*/ ?>
		...
		<div class="headR">
			...
			<p class="p2">
				<a href="#" class="resetPWD">重置密码</a>&nbsp;&nbsp;<a
					href="<?php echo url('Register/loginout'); ?>" target="_parent" class="goOut">退出</a>
			</p>
		</div>
